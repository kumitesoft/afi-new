...
module.exports = __webpack_require__("xM38");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  switch (method) {
    case 'PUT':
      try {
        let item = await _models_itemModel__WEBPACK_IMPORTED_MODULE_1___default.a.find({
          _id: id
        });
        let popularity = item[0].popularity;
        popularity++;
        let itemUpdated = await _models_itemModel__WEBPACK_IMPORTED_MODULE_1___default.a.findByIdAndUpdate({
          _id: id
        }, {
