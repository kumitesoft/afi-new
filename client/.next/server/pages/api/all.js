...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  switch (method) {
    ...
    case 'GET':
      try {
        const items = await _models_itemModel__WEBPACK_IMPORTED_MODULE_1___default.a.find();
    ...
    case 'POST':
      try {
        let item = await new _models_itemModel__WEBPACK_IMPORTED_MODULE_1___default.a({
          name: name,
...
module.exports = __webpack_require__("/FV2");
